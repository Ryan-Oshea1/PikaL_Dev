function [wavelength, spectrum] = ramses_get(calpath,instrumentid, datafile) 

backfile = [calpath 'Back_SAM_' num2str(instrumentid) '.dat'];
calfile = [calpath 'Cal_SAM_' num2str(instrumentid) '.dat']; 
inifile = [calpath 'SAM_' num2str(instrumentid) '.ini'];
...
D = C-nanmean(C(cal(14):cal(15))); %was 14/15
% figure
% plot(D)
% title('D')
...
spectrum = E./S;
wavelength = cal(24)+cal(25).*(1:255)+cal(26).*(1:255).^2+cal(27).*(1:255).^3; %was 24 25 26 27
