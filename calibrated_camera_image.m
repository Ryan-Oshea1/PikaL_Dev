...
function calibrated_image = calibrated_camera_image(image,exposure_time,gain,path_to_unpolarized_cal_images,path_to_polarized_cal_images,select_polarized_images,select_gain_images,CalFolder,camera_wavelengths)
...
if(exposure_time >480000)
    ...
    if(exposure_time <20000)
         rounded_exposure_time = 20000;
    else
