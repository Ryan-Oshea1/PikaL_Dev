...
path = '/media/flagg/15AFC52042FBF9AC/Pika_L/Calibration Files/spectralCalibrationImages/Image__2016-02-13__09-10-11.png'
...
range_spatial = 240:320;
spectral_range = 79:228
subplot(412); imagesc(hyperspectralImageAE(spectral_range,range_spatial))

subplot(413); plot(mean(hyperspectralImageAE(spectral_range,range_spatial),2)/(max(mean(hyperspectralImageAE(spectral_range,range_spatial),2))))
size(camera_wavelengths(1,1:300))
size(mean(hyperspectralImageAE(spectral_range,range_spatial),2)/(max(mean(hyperspectralImageAE(spectral_range,range_spatial),2))))
subplot(414); plot(camera_wavelengths(3,1:150),mean(hyperspectralImageAE(spectral_range,range_spatial),2)/(max(mean(hyperspectralImageAE(spectral_range,range_spatial),2))));% xlim([400 1000])

%figure(300); imagesc(hyperspectralImageAE(1010:1200,300:340))



load('camera_wavelengths_old.mat')
...
figure(31); subplot(211);plot(camera_wavelengths(3,1:150),mean(hyperspectralImageAE(spectral_range,range_spatial),2)/(max(mean(hyperspectralImageAE(spectral_range,range_spatial),2)))); xlim([400 1000])
...
legend('Camera','radiometer')

p= polyfit(spectralCal_4_4(:,1),spectralCal_4_4(:,2),2)
camera_wavelengths_recalibrated = polyval(p,1:150)
camera_wavelengths(3,1:150)=camera_wavelengths_recalibrated;

figure(31); subplot(212);plot(camera_wavelengths_recalibrated,mean(hyperspectralImageAE(spectral_range,range_spatial),2)/(max(mean(hyperspectralImageAE(spectral_range,range_spatial),2)))); xlim([400 1000])
...
legend('Camera','radiometer')
camera_wavelengths(3,1:150)=camera_wavelengths_recalibrated;
save('camera_wavelengths.mat','camera_wavelengths')
%%
