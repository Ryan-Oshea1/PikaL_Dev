function [err,initial_values,rrs_mod,rrs_mea,bbp_650] =  rrs_optimization_func(pgx,wavelengths,trs,srs,aph_const,aph_coef,aw,bbw,g_p_9,g_p_10,g_p_11,sdg,fresnel,gw,sub_to_above_1,sub_to_above_2, trs_wavelengths, srs_wavelengths)
...
%size(finite_trs_loc)
interpolated_trs = interp1(trs_wavelengths(finite_trs_loc),trs(finite_trs_loc),trs_wavelengths,'linear','extrap');
...
AA12_range_lower = ((trs_wavelengths-400)>0) .* ((trs_wavelengths-676)<0); %360 to 675 (whatever that is), 430 was start for success
