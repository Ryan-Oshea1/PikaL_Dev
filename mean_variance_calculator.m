...
function [mean_rows,variance_rows] = mean_variance_calculator(exposure_time,gain,path_to_unpolarized_cal_images,path_to_polarized_cal_images,path_to_darks,select_polarized_images,select_gain_images,CalFolder,camera_wavelengths)
