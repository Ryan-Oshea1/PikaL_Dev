...
function [SNR_image_theoretical, theoretical_snr,spatial_SNR, spatial_rel_practical,environmental_SNR] = snr_calculator_real_world_2(original_image_radiance,original_image_raw,exposure_time,gain,path_to_darks,camera_wavelengths,ADC_gain,spatial_range)
...
if(exposure_time >480000)
 ...
 if(size(original_image_raw,1) == 1200)
     path_set = "1";
    % bin = 1;
     xrange = 316:915;
     yrange = 528:1427;
 ...
 if(size(original_image_raw,1) == 300)
     path_set = "3";
     bin =3;
     xrange = 79:228;
     yrange = 132:356;
