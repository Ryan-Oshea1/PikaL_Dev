      ...
      if(1 == find_usable_sza(water_quality_parameter_times(i),115,155))
        ...
        if(size(all_images(i).(set_num_name_rrs_array(set_num)),1) >400 &&  size(all_images(i).(set_num_name_rrs_array(set_num)),2) >400)
              if(srg_correction == 1)
                ...
                trs_wavelengths = camera_wavelengths(1,:);
